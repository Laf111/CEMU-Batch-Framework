...
---------------------------------------------------------
    ...
    If you have a single issue, delete the shortcut and recreate it whith disabling the automatic import before report any issue on 
    CEMU's reddit or discord
...
Assuming that all users (BatchFw users created with each Windows profile) share the same settings on a given host.
...
=========================================================
    ...
    CEMU 1.15   Support for game's mods and protection of the GLCache under shaderCahce/driver/nvidia;
    CEMU 1.15.6 Save controler profile used in the game's profile when using the UI (right click on the 
                game in the list);
