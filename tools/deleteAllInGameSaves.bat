...
REM : main
    ...
    set "tmpFile="!BFW_PATH:"=!\logs\detectInvalidGamesFolder_daigs.log""
    ...
    if !NB_GAMES_TREATED! NEQ 0 (
        set "msg="!GAME_TITLE!:!DATE!-!USERDOMAIN! delete all in game saves""
...
REM : functions
    ...
    :delSaves
        ...
        rmdir /Q /S !inGameSavesFolder! > NUL 2>&1
